...
<div class="hero bg-base-200 font-Fredoka">
    <div class="hero-content flex-col lg:flex-row min-w-screen">
        <img src="<?php echo e(asset('images/welcome.jpg')); ?>" class="max-w-sm rounded-lg hero-h-sreen" />
        <div class="px-6 w-2/3">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure><img src="<?php echo e(asset('images/icon.png')); ?>" alt="Movie" class="pl-6"/></figure>
                <div class="card-body">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure><img src="<?php echo e(asset('images/icon (1).png')); ?>" alt="Movie" class="pl-6"/></figure>
                <div class="card-body">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure><img src="<?php echo e(asset('images/icon (2).png')); ?>" alt="Movie" class="pl-6"/></figure>
                <div class="card-body">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure><img src="<?php echo e(asset('images/icon (3).png')); ?>" alt="Movie" class="pl-6"/></figure>
                <div class="card-body">
            ...
            <div class="card card-side bg-base-100 shadow-xl w-full">
                <figure><img src="<?php echo e(asset('images/icon (4).png')); ?>" alt="Movie" class="pl-6"/></figure>
                <div class="card-body">
