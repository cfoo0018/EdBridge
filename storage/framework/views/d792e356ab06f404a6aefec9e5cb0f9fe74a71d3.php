...
<!-- <div class="hero bg-base-200 min-w-screen">
    <div class="hero-content flex-col lg:flex-row min-w-screen">
        <img src="<?php echo e(asset('images/welcome.jpg')); ?>" class="max-w-sm rounded-lg shadow-2xl min-h-screen" />
        <div class="px-6 text-center">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure><img src="<?php echo e(asset('images/icon.png')); ?>" alt="Movie" class="p-6"/></figure>
                <div class="card-body">
