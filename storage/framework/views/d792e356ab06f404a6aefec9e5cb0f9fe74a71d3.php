...
<?php $__env->startSection('title', 'BridgeEd'); ?>
...
<div class="hero bg-base-200 font-Fredoka">
    <div class="hero-content lg:mt-20 mb-20 flex-col lg:flex-row min-w-screen sm:mt-5 sm:mb-5">
        <img src="<?php echo e(asset('images/welcome.jpg')); ?>" class="rounded-lg lg:w-1/2 md:hero-h-sreen sm:w-full" />
        <div class="px-6 lg:w-2/3 sm:w-full">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 flex w-full">
                <figure class="lg:w-20 sm:w-1/3"><img src="<?php echo e(asset('images/icon.png')); ?>" alt="icon" class="pl-6 w-full"/></figure>
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 flex w-full">
                <figure class="lg:w-20 sm:w-1/3"><img src="<?php echo e(asset('images/icon (1).png')); ?>" alt="icon" class="pl-6 w-full"/></figure>
                <div class="card-body w-2/3">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure class="lg:w-20 sm:w-1/3" ><img src="<?php echo e(asset('images/icon (2).png')); ?>" alt="icon" class="pl-6 w-full"/></figure>
                <div class="card-body w-2/3">
            ...
            <div class="card card-side bg-base-100 shadow-xl mb-4 w-full">
                <figure class="lg:w-20 sm:w-1/3"><img src="<?php echo e(asset('images/icon (3).png')); ?>" alt="icon" class="pl-6 w-full"/></figure>
                <div class="card-body w-2/3">
            ...
            <div class="card card-side bg-base-100 shadow-xl w-full">
                <figure class="lg:w-20 sm:w-1/3"><img src="<?php echo e(asset('images/icon (4).png')); ?>" alt="icon" class="pl-6 w-full"/></figure>
                <div class="card-body w-2/3">
