...
@section('title', 'BridgeEd - Data Science Knowledge Quest')

@section('content')

<!-- Quiz Title -->
<div id="quiz_title" class="mx-auto md:w-2/3 text-left mt-24 md:mt-36 px-4 md:px-0">
    ...
    <p class="text-xl">Welcome to the Course Pathway Quiz! This quest is designed to help you gauge your understanding of the key concepts covered in the course and identify areas for improvement in your knowledge journey.</p>
</div>
...
<div class="mockup-window border border-base-300 w-4/5 md:w-2/3 mx-auto mb-12">
    ...
    <div id="question-container" class="flex flex-col justify-center text-center px-8 border-t border-base-300">
        ...
        <div class="py-4 md:py-12">
            ...
            <p id="question" class="text-lg md:text-4xl mb-4 md:mb-12 font-semibold md:font-normal">What do you understand by the term 'Data Science'?</p>
            <!-- Answer -->
