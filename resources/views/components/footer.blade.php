<footer class="footer p-10 bg-base-200 text-Second font-Freedoka">
  ...
  <nav>
    <a class="link link-hover font-Freedoka font-semibold">Support</a>
    <a class="link link-hover font-Freedoka font-semibold">Financial Aid</a>
  </nav> 
  <nav>
    <a class="link link-hover font-Freedoka font-semibold">Pathways</a>
  </nav>
  <nav>
    <h6 class="footer-title">Contact</h6> 
    <a class="link link-hover">phone number</a>
