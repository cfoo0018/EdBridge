                ...
                <div id="resource-hub" class="feature mb-20 pt-20 flex flex-col lg:flex-row">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="feature-text p-4" data-aos="fade-right">
                            ...
                            <p>Explore a curated collection of educational resources designed to support vulnerable students. Our Resource Hub offers a range of materials, including STEM and IT-related courses, to empower and guide students in their educational journey.</p>
                            <a href="{{ route('resourcehub') }}"class="mt-4 btn bg-Second text-white hover:text-Second hover:bg-white hover:border-Second">Explore More</a>
                        </div>
                    </div>
                </div>                
                ...
                <div id="support-directory" class="feature mb-20 flex flex-col lg:flex-row-reverse">
                    ...
                    <div class="w-1/2">
                        <div class="feature-text p-4" data-aos="fade-left">
                            ...
                            <a href="{{ route('support.index') }}" class="mt-4 btn bg-Second text-white hover:text-Second hover:bg-white hover:border-Second">Explore More</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="education-pathways" class="feature mb-20 flex flex-col lg:flex-row">
                    ...
                    <div class="w-1/2">
                        <div class="feature-text p-4" data-aos="fade-right">
                            ...
                            <a href="{{ route('pathways') }}" class="mt-4 btn bg-Second text-white hover:text-Second hover:bg-white hover:border-Second">Explore More</a>
                        </div>
                    </div>
                </div>
                ...
                <div id="financial-aid" class="feature mb-23 flex flex-col lg:flex-row-reverse">
                    ...
                    <div class="w-1/2">
                        <div class="feature-text p-4" data-aos="fade-left">
                            ...
                            <a href="{{ route('home') }}" class="mt-4 btn bg-Second text-white hover:text-Second hover:bg-white hover:border-Second">Explore More</a>
                        </div>
                    </div>
                </div>
